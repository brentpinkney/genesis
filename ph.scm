...
(!h (@ 0x25                                                     ; function
       0x01							; n
       0x48 0x8b 0x3e 						; mov    rdi,QWORD PTR [rsi]
       0x81 0xe7 0x00 0xff 0x00 0x00				; and    edi,0xff00
...
(!+ (@ 0x25                                                     ; function
       ...
       0x49 0xba 0xfb 0x00 0x00 0x00 0x00 0x00 0x00 0x00	; movabs r10,0xfb = integer()
       0x41 0xff 0xd2						; call   r10
       0xc3))							; ret
